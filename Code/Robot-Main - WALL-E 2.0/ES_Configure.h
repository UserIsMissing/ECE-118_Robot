...
#define EVENT_CHECK_LIST /* TemplateCheckBattery,  */ Read_TrackWireSensor, WallSensors_ReadAll, TapeSensor_FL, TapeSensor_FR, TapeSensor_RL, TapeSensor_RR, Bumper_Left, Bumper_Right, // WallSensor_BackGate, Read_Bumpers,
